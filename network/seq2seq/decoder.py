...
class LstmDecoder(object):
    ...
    def decode(self, encoded):
        data = mx.sym.Variable('dec_data')  # target input data
        label = mx.sym.Variable('label')  # target label data
        # declare variables
        ...
        init_hs = mx.sym.SliceChannel(data=init_h, num_outputs=self.num_of_layer)
