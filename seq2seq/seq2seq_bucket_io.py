...
class EncoderDecoderIter(mx.io.DataIter):
    def __init__(self, enc_data, dec_data, pad, eos, target_init_states,
        ...
        self.provide_data = [('enc_data', (self.batch_size, enc_dec_bucket_key.enc_len)),
                             ...
                             (target_mask_name, (self.batch_size, enc_dec_bucket_key.dec_len))] + target_init_states
    ...
    def __iter__(self):
        ...
        for i_bucket in self.bucket_plan:
            ...
            data_all = [mx.nd.array(enc_data), mx.nd.array(dec_data)] + self.target_init_state_arrays
            label_all = [mx.nd.array(label)]

            # data_names = ['enc_data',''' 'enc_info',''' 'enc_mask', 'dec_data', 'dec_mask'] + init_state_names
            data_names = ['enc_data', 'dec_data', self.target_mask_name] + target_init_state_names
            label_names = ['label',]
    ...
    def get_data_names(self):
        return ['enc_data', 'dec_data', 'target_mask'] + self.target_init_state_names
